...
public class ItsEnvIoc 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		ItsClkReceiverIoc crioc = new ItsClkReceiverIoc("itsClkRecvr01Ioc", "tcp://broker.shiftr.io:1883", "c8ac7600", "1e45295ac35335a5", "/dev/ttyACM0");

		gioc.setPeriodicPollPeriodmillis(2000);
		dioc.setPeriodicPollPeriodmillis(2000);
		sioc.setPeriodicPollPeriodmillis(2000);
		crioc.setPeriodicPollPeriodmillis(5000);
