...
public class KlyPlcProtoPsuGearBox 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		filByteToothRead[57]	= new ByteTooth("TMPST",			"S7DT",			150, 	0, 		false, 		"0", 	"Last Interlock or Warning Timestamp");
		filByteToothRead[58]	= new ByteTooth("TOTAL_WARMPUP_T",	"SHORT",		158, 	0, 		false, 		"0", 	"Sum of the SetPoints time");

		ByteTooth[] filByteToothWrite = new ByteTooth[37];
		...
		filByteToothWrite[10]		= new ByteTooth("WR_DATA",		"BOOLEAN",		1, 		2, 		true, 		"false", 	"Write Data");
		filByteToothWrite[11]		= new ByteTooth("TIME_COLD_SP1","FLOAT",		2, 		0, 		true, 		"0", 	"Setpoint1 Time");
		filByteToothWrite[12]		= new ByteTooth("TIME_COLD_SP2","FLOAT",		6, 		0, 		true, 		"0", 	"Setpoint2 Time");
		filByteToothWrite[13]		= new ByteTooth("TIME_COLD_SP3","FLOAT",		10, 	0, 		true, 		"0", 	"Setpoint3 Time");
		filByteToothWrite[14]		= new ByteTooth("TIME_WARM_SP1","FLOAT",		14, 	0, 		true, 		"0", 	"Setpoint1 Time if the PSU is already warm");
		filByteToothWrite[15]		= new ByteTooth("TIME_WARM_SP2","FLOAT",		18, 	0, 		true, 		"0", 	"Setpoint2 Time if the PSU is already warm");
		filByteToothWrite[16]		= new ByteTooth("TIME_WARM_SP3","FLOAT",		22, 	0, 		true, 		"0", 	"Setpoint3 Time if the PSU is already warm");
		filByteToothWrite[17]		= new ByteTooth("I_SP1",		"FLOAT",		26, 	0, 		true, 		"0", 	"Setpoint1 Current");
		filByteToothWrite[18]		= new ByteTooth("I_SP2",		"FLOAT",		30, 	0, 		true, 		"0", 	"Setpoint2 Current");
		filByteToothWrite[19]		= new ByteTooth("I_SP3",		"FLOAT",		34, 	0, 		true, 		"0", 	"Setpoint3 Current");
		filByteToothWrite[20]		= new ByteTooth("V_SP1",		"FLOAT",		38, 	0, 		true, 		"0", 	"Setpoint1 Voltage");
		filByteToothWrite[21]		= new ByteTooth("V_SP2",		"FLOAT",		42, 	0, 		true, 		"0", 	"Setpoint2 Voltage");
		filByteToothWrite[22]		= new ByteTooth("V_SP3",		"FLOAT",		46, 	0, 		true, 		"0", 	"Setpoint3 Voltage");
		filByteToothWrite[23]		= new ByteTooth("S_VMON",		"FLOAT",		50, 	0, 		true, 		"0", 	"Force VMON input");
		filByteToothWrite[24]		= new ByteTooth("S_IMON",		"FLOAT",		54, 	0, 		true, 		"0", 	"Force IMON input");
		filByteToothWrite[25]		= new ByteTooth("S_WMON",		"FLOAT",		58, 	0, 		true, 		"0", 	"Force WMON input");
		filByteToothWrite[26]		= new ByteTooth("V_RAMP_RATE",	"FLOAT",		62, 	0, 		true, 		"0", 	"Voltage Ramp rate unit/sec (not used now)");
		filByteToothWrite[27]		= new ByteTooth("I_RAMP_RATE",	"FLOAT",		66, 	0, 		true, 		"0", 	"Current Ramp rate unit/sec (not used now)");
		filByteToothWrite[28]		= new ByteTooth("I_HIHI",		"FLOAT",		70, 	0, 		true, 		"0", 	"Current Alarm High");
		filByteToothWrite[29]		= new ByteTooth("I_LOLO",		"FLOAT",		74, 	0, 		true, 		"0", 	"Current Alarm Low");
		filByteToothWrite[30]		= new ByteTooth("I_HIGH",		"FLOAT",		78, 	0, 		true, 		"0", 	"Current Warning High");
		filByteToothWrite[31]		= new ByteTooth("I_LOW",		"FLOAT",		82, 	0, 		true, 		"0", 	"Current Warning Low");
		filByteToothWrite[32]		= new ByteTooth("W_HIHI",		"FLOAT",		86, 	0, 		true, 		"0", 	"Power Alarm High");
		filByteToothWrite[33]		= new ByteTooth("W_LOLO",		"FLOAT",		90, 	0, 		true, 		"0", 	"Power Alarm Low");
		filByteToothWrite[34]		= new ByteTooth("W_HIGH",		"FLOAT",		94, 	0, 		true, 		"0", 	"Power Warning High");
		filByteToothWrite[35]		= new ByteTooth("W_LOW",		"FLOAT",		98, 	0, 		true, 		"0", 	"Power Warning Low");
		filByteToothWrite[36]		= new ByteTooth("TOL_InWARMUP_SP",	"FLOAT",		102, 	0, 		true, 		"0", 	"Maximum allowed difference between IMON and IPGM");
		...
		solByteToothRead[34]	= new ByteTooth("TMPST",		"S7DT",			74, 		0, 		false, 		"0", 	"Last Interlock or Warning Timestamp");
		...
		ByteTooth[] solByteToothWrite = new ByteTooth[21];
		...
		solByteToothWrite[8]		= new ByteTooth("WR_DATA",		"BOOLEAN",		1, 		0, 		true, 		"false", 	"Write data");
		solByteToothWrite[9]		= new ByteTooth("I_SP",			"FLOAT",		2, 		0, 		true, 		"0", 	"Setpoint Current");
		solByteToothWrite[10]		= new ByteTooth("V_SP",			"FLOAT",		6, 		0, 		true, 		"0", 	"Setpoint Voltage");
		solByteToothWrite[11]		= new ByteTooth("S_VMON",		"FLOAT",		10, 	0, 		true, 		"0", 	"Force VMON input");
		solByteToothWrite[12]		= new ByteTooth("S_IMON",		"FLOAT",		14, 	0, 		true, 		"0", 	"Force IMON input");
		solByteToothWrite[13]		= new ByteTooth("I_HIHI",		"FLOAT",		18, 	0, 		true, 		"0", 	"Current Alarm High");
		solByteToothWrite[14]		= new ByteTooth("I_LOLO",		"FLOAT",		22, 	0, 		true, 		"0", 	"Current Alarm Low");
		solByteToothWrite[15]		= new ByteTooth("I_HIGH",		"FLOAT",		26, 	0, 		true, 		"0", 	"Current Warning High");
		solByteToothWrite[16]		= new ByteTooth("I_LOW",		"FLOAT",		30, 	0, 		true, 		"0", 	"Current Warning Low");
		solByteToothWrite[17]		= new ByteTooth("V_HIHI",		"FLOAT",		34, 	0, 		true, 		"0", 	"Voltage Alarm High");
		solByteToothWrite[18]		= new ByteTooth("V_LOLO",		"FLOAT",		38, 	0, 		true, 		"0", 	"Voltage Alarm Low");
		solByteToothWrite[19]		= new ByteTooth("V_HIGH",		"FLOAT",		42, 	0, 		true, 		"0", 	"Voltage Warning High");
		solByteToothWrite[20]		= new ByteTooth("V_LOW",		"FLOAT",		46, 	0, 		true, 		"0", 	"Voltage Warning Low");
