...
import se.esss.litterbox.itsllrfgwt.client.EntryPointApp;
...
public class CheckIpAddresslAsyncCallback implements AsyncCallback<String[]>
{
	...
	public void onSuccess(String[] result) 
	{
		...
		if (!ipOkay)
		{
			...
			entryPointApp.getSetupApp().getMessageDialog().setMessage("Varning", "Outside user: You can look but not touch", true);
