package se.esss.litterbox.its.archivergwt.client.gskel;

import com.google.gwt.user.client.ui.VerticalPanel;

import se.esss.litterbox.its.archivergwt.client.EntryPointApp;
import se.esss.litterbox.its.archivergwt.client.EntryPointAppServiceAsync;
import se.esss.litterbox.its.archivergwt.client.gskel.GskelOptionDialog.GskelOptionDialogInterface;
import se.esss.litterbox.its.archivergwt.client.gskel.GskelTabLayoutPanel.GSkelTabLayoutPanelInterface;
...
public abstract class GskelVerticalPanel extends VerticalPanel implements GSkelTabLayoutPanelInterface, GskelOptionDialogInterface
{
	...
	public EntryPointApp getEntryPointApp() {return getSetupApp().getEntryPointApp();}
}
